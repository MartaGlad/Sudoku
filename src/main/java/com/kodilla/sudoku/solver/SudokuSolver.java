...
public class SudokuSolver {
    ...
    private boolean isSubsectionValid(int row, int col) {
        ...
        int subsectionRowStart = (row / SudokuBoard.SUBSECTION_SIZE) * SudokuBoard.SUBSECTION_SIZE;
        int subsectionRowEnd = subsectionRowStart + SudokuBoard.SUBSECTION_SIZE;

        int subsectionColStart = (col / SudokuBoard.SUBSECTION_SIZE) * SudokuBoard.SUBSECTION_SIZE;
        int subsectionColEnd = subsectionColStart + SudokuBoard.SUBSECTION_SIZE;
